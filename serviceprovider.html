            ...
            <table class="table table-bordered table-striped">
              <tbody><tr>
                <td style="width: 100px; height: 100px;">
                  ...
                  <td class="span4"><font style="color: #3b5998; font-weight: bold; font-size: 13px; line-height: 1.38; font-family: 'lucida grande',tahoma,verdana,arial,sans-serif;">Swati Khanna</font><br>
                  ...
                  <td class="span4"><font style="float:right; color: #3b5998; font-weight: bold; font-size: 13px; line-height: 1.38; font-family: 'lucida grande',tahoma,verdana,arial,sans-serif;">Dinesh Shah</font><br>
                    ...
                    <td style="width: 100px;">
                      ...
                      <tr><td colspan="4" style="width: 100%;">
                       <div class="raty" style="float: right; width: 100px; cursor: pointer;"><img src="img/star-on.png" alt="1" title="bad">&nbsp;<img src="img/star-on.png" alt="2" title="poor">&nbsp;<img src="img/star-on.png" alt="3" title="regular">&nbsp;<img src="img/star-on.png" alt="4" title="good">&nbsp;<img src="img/star-off.png" alt="5" title="gorgeous"><input type="hidden" name="score" value="4"></div>
              ...
              <div class="box-content" style="display: block;">
                ...
                <table class="table table-bordered table-striped">
                  <tbody><tr>
                    ...
                    <td style="width: 100px;">
                      <a style="background-color:white" title="User5" href="images/user2.png" class="cboxElement"><img src="images/user2.png" alt="User2"></a></td>


                      <td><font style="color: #3b5998; font-weight: bold; font-size: 13px; line-height: 1.38; font-family: 'lucida grande',tahoma,verdana,arial,sans-serif;">Roger Fernandes</font><br> <br>
                       ...
                       <p style="color: #333; font-size: 13px;line-height: 1.38; font-weight: normal; font-family: 'lucida grande',tahoma,verdana,arial,sans-serif;">
                        ...
                        Do you also sell Ayurvedic medicines?<br>
                        <font style="color: #999; font-family: 'lucida grande',tahoma,verdana,arial,sans-serif;
                ...
                <table class="table table-bordered table-striped">
                  <tbody><tr>
                    ...
                    <td style="width: 100px;">
                      ...
                      <td><font style="color: #3b5998; font-weight: bold; font-size: 13px; line-height: 1.38; font-family: 'lucida grande',tahoma,verdana,arial,sans-serif;">Rashmi Sharma</font><br><br>
